          ...
          <Table.Body>
            {response.trading_card.variants.map((variant) => (
              <Table.Row key={variant.id}>
                <Table.Cell>
                  <Text size="small">{variant.condition}</Text>
                  <Text size="xsmall" className="text-ui-fg-subtle">{variant.condition_source}</Text>
                </Table.Cell>
                <Table.Cell>
                  <Text size="small">{variant.finish} {variant.finish_confirmed ? "confirmed" : "review"}</Text>
                  <Text size="xsmall" className="text-ui-fg-subtle">
                    {variant.special_treatment} {variant.special_treatment_confirmed ? "confirmed" : "review"}
                  </Text>
                </Table.Cell>
