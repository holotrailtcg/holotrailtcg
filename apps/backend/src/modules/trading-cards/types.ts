...
export const AUDIT_ACTION = {
  ...
  TCGDEX_MANUAL_REFERENCE_REVERTED: "TCGDEX_MANUAL_REFERENCE_REVERTED",
  TCGDEX_MANUAL_REFERENCE_COMPENSATION_SKIPPED_STALE: "TCGDEX_MANUAL_REFERENCE_COMPENSATION_SKIPPED_STALE",
  TCGDEX_MANUAL_REFERENCE_COMPENSATION_FAILED: "TCGDEX_MANUAL_REFERENCE_COMPENSATION_FAILED",
  TCGDEX_AMBIGUOUS_CANDIDATE_RESOLVED: "TCGDEX_AMBIGUOUS_CANDIDATE_RESOLVED",
} as const
